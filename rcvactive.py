...
try:
    while True:
        ...
        if line.startswith("csv,"):
            print(f"CSV Data received: {line}")
        ...
        # === Activation ===
            ...
            timestamp = time.strftime('%Y-%m-%d %H:%M:%S')
            print(f"Activation signal received at {timestamp}")
            with open(log_file, "a") as f:
                f.write(f"{timestamp},Activation,-,-\n")
        ...
        # === Image Start ===
            ...
            try:
                ...
                print(f"Starting image reception: {current_image_name} | Expected Chunks: {expecting_chunks}")
            except ValueError:
                print("Invalid IMGSTART format")
        ...
        # === Image End ===
            ...
            if image_receiving and len(received_chunks) == expecting_chunks:
                ...
                print(f"Incomplete image: expected {expecting_chunks}, got {len(received_chunks)}")
            image_receiving = False
            received_chunks = []
            current_image_name = None
